 ...
 *
 * Disassembly of winmax3-dsdt.dat, Mon Dec 19 20:42:44 2022
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00006DDD (28125)
 *     Revision         0x02
 *     Checksum         0x7E
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x0107200a)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xB3175000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xB3179000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xB8264F18)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xB8252D18, 0x0D)
        ...
        Device (RHUB)
        {
            ...
            Device (PRT1)
            {
                ...
                Device (PRT1)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.PRT1.UPC1 */
                    }
                    ...
                    Name (PLD1, Package (0x01)
                    {
                        Buffer (0x14)
                        {
                            ...
                            /* 0008 */  0x69, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00,  // i.......
                            /* 0010 */  0xFF, 0xFF, 0xFF, 0xFF                           // ....
                        }
                    })
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.PRT1.PLD1 */
                    }
                }
                ...
                Device (PRT2)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.PRT2.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.PRT2.PLD1 */
                    }
                }
                ...
                Device (PRT3)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.PRT3.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.PRT3.PLD1 */
                    }
                }
                ...
                Device (PRT4)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.PRT4.UPC1 */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.PRT4.PLD1 */
                    }
                }
            }
