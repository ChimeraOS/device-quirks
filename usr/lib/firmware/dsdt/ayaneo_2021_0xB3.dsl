 ...
 *
 * Disassembly of dsdt.dat, Mon Jul 10 18:51:47 2023
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008A5C (35420)
 *     Revision         0x02
 *     Checksum         0xB3
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x0107200a)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xCC51D000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xCC521000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xCC73BF98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
